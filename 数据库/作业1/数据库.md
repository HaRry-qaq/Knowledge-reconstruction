...
```sql
-- Active: 1665215239056@@127.0.0.1@3306



/* 3.1 */

create database hwk1 default character set utf8mb4 collate utf8mb4_unicode_ci;
...
create database hwk2 default character set utf8mb4 collate utf8mb4_unicode_ci;
...
/* f. */
with a as (
	select company_name, count(employee_name) as num
	from works
